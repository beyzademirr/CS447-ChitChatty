        ...
        try:
            ...
            if(index1!=-1):            
                ...
                if(index2!=-1):
                    ...
                    keys.remove(key1)
                    keys.remove(key2)
                    #group.append(client2)
                    #group_nicks.append(client2)
                    break
                clients.remove(client)
                client.close()
                nickname = nicknames[index1]
                ...
                index = ind(group, client)
                if(index!=-1):
                    group.remove(client)
                    client.close()
                    nickname = group_nicks[index]
                    group_nicks.remove(nickname)
                    break
                else:
                    client.close()
                    break
